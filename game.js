...
(function() {
  var acknowledgeInputCity, addCityTile, checkBusyStatus, computerTurn, currCityNeverUsed, currLetterStartsCityname, formatNameForWikipedia, generateCloseWordList, generateEditDistanceList, getEditDistance, handleComputerTurn, handleErrors, incrementKeyFrequencyInMap, isValidCity, printCountries, resultColor, resultText, setBusy, setNotBusy, testCityIsInvalid, testCityIsValid, testWordsDontMatch, testWordsMatch, updateProgramAndDisplay, updateWithNewCity,
  ...
  updateWithNewCity = function() {
    ...
    return $('.currletter').text(curr_letter);
  };

  addCityTile = function(cityname) {
    var tile;
    tile = $('<div class="city" />');
    tile.text(cityname);
  ...
  formatNameForWikipedia = function(cityname) {};
